...
import {DecreasingProtocolTokenMinter} from "../DecreasingProtocolTokenMinter.sol";
...
contract DecreasingProtocolTokenMinterTest is DSTest {
    Hevm hevm;

    DSDelegateToken               protocolToken;
    DecreasingProtocolTokenMinter minter;
    ProtocolTokenAuthority        authority;

    uint256 initialSupply       = 1000000E18;
    uint256 amountToMintPerWeek = 7000E18;
    uint256 weeklyMintDecay     = 0.9947E18;
    ...
    function setUp() public {
        ...
        minter = new DecreasingProtocolTokenMinter(
          address(0x1),
    ...
    function test_mint_full_initial_period() public {
        ...
        assertEq(protocolToken.totalSupply(), 1744263666922926654843959);
    }
